...
def gui():
    ...
    button1 = tk.Button(window,width=15,activebackground='lightgoldenrod',bg='goldenrod',font=("Calibri",15),text="Done",command=lambda:judge(table2,var1)).grid(columnspan=9,rowspan=3)
    boutton2 = tk.Button(window,width=15,activebackground='lightgoldenrod',bg='goldenrod',font=("Calibri",15),text="Restart",command=lambda:[window.destroy(),clear(),generate(),solveSudoku(table),set_ques(Template),gui()]).grid(columnspan=9,rowspan=3)
    window.mainloop()
